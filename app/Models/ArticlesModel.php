...
class ArticlesModel extends CoreModel
{
    ...
    {
        $sql = "INSERT INTO ".$this->table." (id, title, category_id, intro_text, intro_img, full_text, visit,slug) VALUES (NULL, :title, :category_id, :intro_text, :intro_img, :full_text, :visit, :slug);" ;
        $stmt = $this->db->prepare($sql);
        ...
        $stmt->bindValue(":visit", $data['visit'], \PDO::PARAM_INT);
